...
## 🛠️ (Deuda Técnica)
[x]1.- Cuando el usuario abre su pantalla, y tiene mas de 1 rutina asignada, en la app, solo puede ver 1 rutina.
...
[x]5.- Quiza cambiar el color de la pantalla del paciente o algo que lo diferencíe del fisio.
[x]6.- En las notificaciones agregar el nombre del paciente.
...
[x]9.- Cuando un ejercicio sobre pase el EVA u otro parametro, enviar notificación al fisio.
[x]10.- Saludar al paciente por su nombre "Hola NOMBRE_DE_PACIENTE", ¡Es hora de tu rutina! o de hacer ejercicio."
11.- Notificar al fisio cuando la rutina de un paciente este por terminar (3 dias antes o algo similar).
[x]12.- Un dashboard general donde el fisio vea a todos los pacientes en una sola pantalla, con los avances y fechas, muy general, y estadisticas.
...
[x]⏳ notification_bell.dart: Pintar la campanita de blanco para que no se pierda en el fondo oscuro.

[x]⏳ main_physio_screen.dart: Es probable que la barra de navegación inferior (BottomNav) siga siendo gris o básica. La haremos elegante y moderna.
...
[x]⏳ physio_calendar_screen.dart: Darle el toque Dark Slate a la cabecera del calendario para que haga juego con el Dashboard.

3. El Lado del Paciente (Detalles finales)

[x]⏳ patient_routine_screen.dart: La pantalla donde el paciente ve la lista de videos antes de entrenar. Le daremos un toque más deportivo para que coincida con su pantalla de inicio.