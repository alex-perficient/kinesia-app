...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _signIn() async {
    ...
    try {
      ...
      DocumentSnapshot physioDoc = await FirebaseFirestore.instance.collection('physiotherapists').doc(uid).get();

      if (physioDoc.exists) {
        // ES FISIOTERAPEUTA -> Lo mandamos a la pantalla con el menú inferior
        if (mounted) {
          Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const MainPhysioScreen()));
        }
      } else {
              ...
              child: SingleChildScrollView(
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      // LOGOTIPO
                      const Text('Kines.ia', textAlign: TextAlign.center, style: TextStyle(fontSize: 40, fontWeight: FontWeight.w900, color: darkSlate, letterSpacing: -1.5)),
                      const SizedBox(height: 8),
                      const Text('Alto Rendimiento y Rehabilitación', textAlign: TextAlign.center, style: TextStyle(fontSize: 14, color: Colors.grey, fontWeight: FontWeight.bold)),
                      ...
                      TextField(
                        ...
                        inputFormatters: [
                          ...
                          LengthLimitingTextInputFormatter(50), // Límite de 50 caracteres
                        ],
                      ...
                      TextField(
                        ...
                        inputFormatters: [
                          FilteringTextInputFormatter.deny(RegExp(r'\s')), // Bloquea espacios
                          LengthLimitingTextInputFormatter(32), // Límite de 32 caracteres
                        ],
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(backgroundColor: darkSlate, foregroundColor: Colors.white, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)), elevation: 4),
                          child: _isLoading
                      ...
                      TextButton(
                        ...
                        child: const Text('¿Eres nuevo? Regístrate aquí', style: TextStyle(color: Colors.teal, fontSize: 14, fontWeight: FontWeight.bold)),
                      ),
                    ],
                  ),
                ),
