...
class PhysioProfileScreen extends StatelessWidget {
    ...
    try {
      ...
      if (!patientDoc.exists) {
        await patientRef.set({
          ...
          'status': 'active',
          'patientType':
              'Fitness', // Perfil orientado a su propio entrenamiento
      ...
      if (context.mounted) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Error al cambiar de modo: $e')));
      }
    }
  }
  ...
  void _showShareBottomSheet(
    ...
    final String inviteLink =
        "https://kinesia-app.web.app/invite?physio=$currentUserId";
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Pídeles que escaneen este código desde su celular para vincularse automáticamente a tu clínica.',
            ...
            child: Column(
              ...
              children: [
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              plan == 'pro' ? Icons.star : Icons.verified,
                              color: plan == 'pro'
                                  ? Colors.amber
                                  : Colors.white70,
                              size: 16,
                ...
                _buildMenuButton(
                  ...
                  subtitle:
                      'Cambia a la vista de atleta para registrar tus rutinas',
                  color: Colors.orange,
                  onTap: () => _enterAthleteMode(
                    context,
                    currentUserId,
                    name,
                    email,
                  ), // Conectado al nuevo motor
                ),
                ...
                _buildMenuButton(
                  ...
                  onTap: () {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Ajustes en desarrollo...')),
                    );
                  },
                ),
